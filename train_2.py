...
def train(hyperparams, train_path, test_path, seed=None):
    ...
    for epoch in range(hyperparams["epochs"]):
        ...
        if avg_token_acc > best_acc:
            best_acc = avg_token_acc
            torch.save({
                'epoch': epoch,
    ...
    return avg_token_acc, avg_seq_acc, best_acc

if __name__ == "__main__":
    train(None, "data/simple_split/size_variations/tasks_train_simple_p8.txt", "data/simple_split/size_variations/tasks_test_simple_p8.txt", seed=42)