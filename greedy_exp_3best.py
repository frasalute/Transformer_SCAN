...
def print_results_and_plot(results):
    ...
    for size, accuracies in results.items():
        ...
        best_token_accuracies.append(best_token_accuracy * 100)  
        token_stds.append(token_std * 100)  
        best_seq_accuracies.append(best_seq_accuracy * 100)  
        seq_stds.append(seq_std * 100)  
        sizes.append(size)  
